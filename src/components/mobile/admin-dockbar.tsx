...
export function AdminDockbar() {
  ...
  return (
    <nav
      ...
      className="lg:hidden fixed bottom-3 left-2.5 right-2.5 sm:left-6 sm:right-6 max-w-lg mx-auto z-50 bg-white/80 backdrop-blur-2xl border border-white/80 shadow-[0_12px_36px_rgba(2,132,199,0.16)] ring-1 ring-black/5 rounded-3xl p-1.5 flex items-center justify-around transition-all"
    >
